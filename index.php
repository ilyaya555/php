...
<div class="first">
<?php
$v= 'Уважаемый № '. rand(1,1123);
$x = $v. ' вам не повезло, вы призывник, ха-ха';
...
<?php
define('USER', 'Илья');
define('PETS', ['тюлень','удод', 'мухоед' ]);
echo '<p> Привет, '.USER.'. Как поживает твой '. PETS [1].'?</p>';
echo '<h1>Ты используешь PHP - движок версии'. PHP_VERSION;
echo ' запущенный в '.PHP_OS.' </h1>';
?>
</div>
